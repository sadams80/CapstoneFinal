...
namespace DataAccessLayer.DataSets {
    ...
    public partial class Users : global::System.Data.DataSet {
        ...
        public partial class UsersDataTable : global::System.Data.TypedTableBase<UsersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public UsersRow AddUsersRow(string FirstName, string LastName, int Age, string Gender, string Email, string Username, string Password, int House_ID, int Role_ID) {
...
namespace DataAccessLayer.DataSets.UsersTableAdapters {
    ...
    public partial class UsersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Users] ([FirstName], [LastName], [Age], [Gender], [Email], [Username], [Password], [House_ID], [Role_ID]) VALUES (@FirstName, @LastName, @Age, @Gender, @Email, @Username, @Password, @House_ID, @Role_ID);
SELECT User_ID, FirstName, LastName, Age, Gender, Email, Username, Password, House_ID, Role_ID FROM Users WHERE (User_ID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Users] SET [FirstName] = @FirstName, [LastName] = @LastName, [Age] = @Age, [Gender] = @Gender, [Email] = @Email, [Username] = @Username, [Password] = @Password, [House_ID] = @House_ID, [Role_ID] = @Role_ID WHERE (([User_ID] = @Original_User_ID) AND ((@IsNull_FirstName = 1 AND [FirstName] IS NULL) OR ([FirstName] = @Original_FirstName)) AND ((@IsNull_LastName = 1 AND [LastName] IS NULL) OR ([LastName] = @Original_LastName)) AND ((@IsNull_Age = 1 AND [Age] IS NULL) OR ([Age] = @Original_Age)) AND ((@IsNull_Gender = 1 AND [Gender] IS NULL) OR ([Gender] = @Original_Gender)) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)) AND ((@IsNull_Username = 1 AND [Username] IS NULL) OR ([Username] = @Original_Username)) AND ((@IsNull_Password = 1 AND [Password] IS NULL) OR ([Password] = @Original_Password)) AND ((@IsNull_House_ID = 1 AND [House_ID] IS NULL) OR ([House_ID] = @Original_House_ID)) AND ((@IsNull_Role_ID = 1 AND [Role_ID] IS NULL) OR ([Role_ID] = @Original_Role_ID)));
SELECT User_ID, FirstName, LastName, Age, Gender, Email, Username, Password, House_ID, Role_ID FROM Users WHERE (User_ID = @User_ID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT User_ID, FirstName, LastName, Age, Gender, Email, Username, Password, Hous" +
                "e_ID, Role_ID FROM dbo.Users";
        ...
        public virtual int Delete(int Original_User_ID, string Original_FirstName, string Original_LastName, global::System.Nullable<int> Original_Age, string Original_Gender, string Original_Email, string Original_Username, string Original_Password, global::System.Nullable<int> Original_House_ID, global::System.Nullable<int> Original_Role_ID) {
            ...
            if ((Original_House_ID.HasValue == true)) {
                ...
                this.Adapter.DeleteCommand.Parameters[16].Value = ((int)(Original_House_ID.Value));
            }
            else {
        ...
        public virtual int Insert(string FirstName, string LastName, global::System.Nullable<int> Age, string Gender, string Email, string Username, string Password, global::System.Nullable<int> House_ID, global::System.Nullable<int> Role_ID) {
            if ((FirstName == null)) {
        ...
        public virtual int Update(
            ...
            if ((House_ID.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[7].Value = ((int)(House_ID.Value));
            }
            else {
            ...
            if ((Original_House_ID.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[25].Value = ((int)(Original_House_ID.Value));
            }
            else {
        ...
        public virtual int Update(
                    ...
                    global::System.Nullable<int> Original_House_ID, 
                    global::System.Nullable<int> Original_Role_ID) {
            return this.Update(FirstName, LastName, Age, Gender, Email, Username, Password, House_ID, Role_ID, Original_User_ID, Original_FirstName, Original_LastName, Original_Age, Original_Gender, Original_Email, Original_Username, Original_Password, Original_House_ID, Original_Role_ID, Original_User_ID);
        }
    }
